...
lispVal =
  hashVal
    ...
    <|> Atom . T.unpack <$> identifier
    <|> String . T.unpack <$> textLiteral
...
parseWespiser :: String -> Either ParseError LispVal
parseWespiser = parse (contents lispVal) "<wespiser>" . T.pack